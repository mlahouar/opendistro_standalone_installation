...
openssl x509 -req -in ${CN}.csr -CA ${CA_crt} -CAkey ${CA_key} -CAcreateserial -out ${CN}.crt -days 1095 -sha256 -extensions v3_req -extfile ${CN}_req.cnf -passin pass:${CA_key_pass}
